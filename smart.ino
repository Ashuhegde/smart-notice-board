...
const char* ssid = "ashwini";  //wifi ssid
const char* password = "ashwini2304";   //wifi password
...
<p> <font size="9" face="sans-serif"> <marquee> Smart Notice Board </marquee> </font> </p>
  </head><body style="background:pink"><center>
  <form action="/get" style="font-size:15px">
